...
const CommunityServices = () => {
  return (
    <section id="community" className="px-6 py-16 bg-gradient-to-b from-green-200 to-blue-300 text-gray-800">
      <h3 className="text-4xl font-bold text-center mb-12 text-white">Giving Back to the Community</h3>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        ...
        <div className="bg-white shadow-xl hover:shadow-2xl transition-shadow rounded-lg overflow-hidden transform hover:scale-105 duration-300">
          <img src={campImage3} alt="Dental Conference" className="w-full h-64 object-cover" />
          <div className="p-6">
            <h4 className="text-xl font-semibold text-teal-500 mb-4">Dental Conference Participation</h4>
            <p className="text-sm text-gray-600">
              Our doctors actively participate in national dental conferences, enhancing their skills and knowledge to provide better care.
            </p>
          </div>
        </div>
      </div>
